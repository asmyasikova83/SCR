...
#ax.fill_between(time, y1 = p_mul_min, y2 = p_mul_max, where = (p_val < 0.1), facecolor = 'b', alpha = 0.99, step = 'pre')
...
plt.savefig(f'/net/server/data/Archive/prob_learn/asmyasnikova83/SCR/ZZ_deriv_risk_trained_{cond1}_vs_{cond2}_{group}_')
plt.close()
